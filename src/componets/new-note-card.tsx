...
interface newNoteCardProps {
  onNoteCreated:(contente: string) => void
}
...
function handleStartRecording() {
  ...
  function handleStopRecording() {
    ...
    return (
      <Dialog.Root>
          <Dialog.Trigger className='rounded-md flex flex-col gap-3 outline-none text-left bg-slate-700 p-5 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
